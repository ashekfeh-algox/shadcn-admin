              ...
              <div>
                ...
                <div className="flex gap-1">
                  ...
                  <LearnMore open={opened} onOpenChange={setOpened} contentProps={{ side: "right" }}>
                    ...
                    <p className="mt-4">
                      You can sign out or manage/delete your account via the User Profile menu in the top-right corner
                      of the page.
    ...
    <div className="h-svh">
      <div className="m-auto flex h-full w-full flex-col items-center justify-center gap-2">
        ...
        <p className="text-center text-muted-foreground">
          ...
          <sup>
            <LearnMore open={opened} onOpenChange={setOpened}>
              ...
              <p className="mt-4">
                After signing in, you'll be able to sign out or delete your account via the User Profile dropdown on
                this page.
              </p>
            </LearnMore>
          </sup>
        ...
        <div className="mt-4 h-8 text-center">
          {!cancelled && !opened && (
            <>
              <p>{countdown > 0 ? `Redirecting to Sign In page in ${countdown}s` : "Redirecting..."}</p>
