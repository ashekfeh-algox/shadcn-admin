...
function MissingClerkPubKey() {
  ...
  return (
    <AuthenticatedLayout>
      <div className="flex h-16 justify-between bg-background p-4">
      ...
      <Main className="flex flex-col items-center justify-start">
        <div className="max-w-2xl">
          ...
          <h1 className="mt-4 font-bold text-2xl">Set your Clerk API key</h1>
          <div className="mt-4 flex flex-col gap-y-4 text-foreground/75">
            <ol className="list-inside list-decimal space-y-1.5">
              <li>
                ...
                <a
                  ...
                  target="_blank"
                  className="underline decoration-dashed underline-offset-4 hover:decoration-solid" rel="noopener"
                >
                  Clerk
                  <sup>
              ...
              <li>
                Rename <code className={codeBlock}>.env.example</code> to <code className={codeBlock}>.env</code>
              </li>
              <li>
            ...
            <div className="@container space-y-2 rounded-md bg-slate-800 px-3 py-3 text-slate-200 text-sm">
          ...
          <Alert>
            ...
            <AlertDescription>
              <p className="text-balance">
                The Clerk integration lives entirely inside <code className={codeBlock}>src/routes/clerk</code>. If you
                plan to use Clerk as your auth service, you might want to place{" "}
                <code className={codeBlock}>ClerkProvider</code> at the root route.
              </p>
              <p>
                However, if you don't plan to use Clerk, you can safely remove this directory and related dependency_{" "}
