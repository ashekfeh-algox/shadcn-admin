...
import { RadioGroupItem } from "./common/radio-group-item";
...
export function SidebarConfig() {
  ...
  return (
    <div className="max-md:hidden">
      ...
      <Radio value={variant} onValueChange={setVariant} className="grid w-full max-w-md grid-cols-3 gap-4">
        {[
          {
            value: "inset",
            label: "Inset",
      ...
      <div className="sr-only">Choose between inset, floating, or standard sidebar layout</div>
    </div>
  );
}
